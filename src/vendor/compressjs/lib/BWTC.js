...
module.exports = (function(freeze, BWT, DefSumModel, FenwickModel, LogDistanceModel, NoModel, RangeCoder, Stream, Util) {
    var EOF = Stream.EOF;
    ...
    return BWTC;
})(require('./freeze'), require('./BWT'), require('./DefSumModel'), require('./FenwickModel'), require('./LogDistanceModel'), require('./NoModel'), require('./RangeCoder'), require('./Stream'), require('./Util'));
