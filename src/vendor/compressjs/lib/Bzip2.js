...
*/
module.exports = (function(freeze, BitStream, BWT, CRC32, HuffmanAllocator, Stream, Util) {
...
return Bzip2;
})(require('./freeze'), require('./BitStream'), require('./BWT'), require('./CRC32'), require('./HuffmanAllocator'), require('./Stream'), require('./Util'));
