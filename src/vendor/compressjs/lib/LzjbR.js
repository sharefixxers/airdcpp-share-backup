...
module.exports = (function(Context1Model, FenwickModel, LogDistanceModel, NoModel, RangeCoder, Stream, Util) {
...
return LzjbR;
})(require('./Context1Model'), require('./FenwickModel'), require('./LogDistanceModel'), require('./NoModel'), require('./RangeCoder'), require('./Stream'), require('./Util'));
