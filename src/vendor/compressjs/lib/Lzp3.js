 ...
 */
module.exports = (function(BitStream, Context1Model, DefSumModel, FenwickModel, Huffman, LogDistanceModel, NoModel, RangeCoder, Stream, Util) {
...
return Lzp3;
})(require('./BitStream'), require('./Context1Model'), require('./DefSumModel'), require('./FenwickModel'), require('./Huffman'), require('./LogDistanceModel'), require('./NoModel'), require('./RangeCoder'), require('./Stream'), require('./Util'));
